...
struct  EDeviceActivityLevel_t886867856 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EDeviceActivityLevel_t886867856, ___value___1)); }
