...
struct  EOverlayDirection_t2759670492 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EOverlayDirection_t2759670492, ___value___1)); }
