...
struct  ETrackedControllerRole_t361251409 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ETrackedControllerRole_t361251409, ___value___1)); }
