...
struct  ETrackedDeviceClass_t2121051631 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ETrackedDeviceClass_t2121051631, ___value___1)); }
