...
struct  ETrackedDeviceProperty_t3226377054 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ETrackedDeviceProperty_t3226377054, ___value___1)); }
