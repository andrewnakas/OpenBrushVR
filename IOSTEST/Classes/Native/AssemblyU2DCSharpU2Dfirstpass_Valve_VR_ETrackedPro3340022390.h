...
struct  ETrackedPropertyError_t3340022390 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ETrackedPropertyError_t3340022390, ___value___1)); }
