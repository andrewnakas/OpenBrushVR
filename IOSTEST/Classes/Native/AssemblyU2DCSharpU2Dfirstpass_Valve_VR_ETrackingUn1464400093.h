...
struct  ETrackingUniverseOrigin_t1464400093 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ETrackingUniverseOrigin_t1464400093, ___value___1)); }
