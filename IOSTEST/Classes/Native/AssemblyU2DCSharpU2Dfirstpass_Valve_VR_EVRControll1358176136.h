...
struct  EVRControllerAxisType_t1358176136 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EVRControllerAxisType_t1358176136, ___value___1)); }
