...
struct  EVRNotificationStyle_t1858720717 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EVRNotificationStyle_t1858720717, ___value___1)); }
