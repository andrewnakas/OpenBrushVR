...
struct  EVRNotificationType_t408717238 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EVRNotificationType_t408717238, ___value___1)); }
