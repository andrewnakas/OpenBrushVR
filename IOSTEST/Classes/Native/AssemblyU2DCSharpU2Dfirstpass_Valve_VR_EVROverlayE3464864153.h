...
struct  EVROverlayError_t3464864153 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EVROverlayError_t3464864153, ___value___1)); }
