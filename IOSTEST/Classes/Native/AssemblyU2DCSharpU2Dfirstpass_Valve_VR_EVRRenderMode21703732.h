...
struct  EVRRenderModelError_t21703732 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EVRRenderModelError_t21703732, ___value___1)); }
