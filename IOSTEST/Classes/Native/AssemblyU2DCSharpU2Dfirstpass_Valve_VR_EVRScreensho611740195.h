...
struct  EVRScreenshotType_t611740195 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EVRScreenshotType_t611740195, ___value___1)); }
