...
struct  EVRScreenshotPropertyFilenames_t29427162 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EVRScreenshotPropertyFilenames_t29427162, ___value___1)); }
