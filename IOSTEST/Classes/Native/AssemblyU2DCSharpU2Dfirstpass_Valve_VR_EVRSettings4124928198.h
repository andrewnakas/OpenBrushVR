...
struct  EVRSettingsError_t4124928198 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EVRSettingsError_t4124928198, ___value___1)); }
