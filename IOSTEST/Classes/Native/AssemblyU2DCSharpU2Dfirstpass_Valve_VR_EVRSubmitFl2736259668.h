...
struct  EVRSubmitFlags_t2736259668 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EVRSubmitFlags_t2736259668, ___value___1)); }
