...
struct  EVRTrackedCameraError_t3529690400 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EVRTrackedCameraError_t3529690400, ___value___1)); }
