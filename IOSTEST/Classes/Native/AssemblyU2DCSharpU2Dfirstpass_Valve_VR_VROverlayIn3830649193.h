...
struct  VROverlayInputMethod_t3830649193 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(VROverlayInputMethod_t3830649193, ___value___1)); }
