...
struct  VROverlayTransformType_t3148689642 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(VROverlayTransformType_t3148689642, ___value___1)); }
