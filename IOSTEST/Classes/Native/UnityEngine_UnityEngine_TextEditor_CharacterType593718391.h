...
struct  CharacterType_t593718391 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(CharacterType_t593718391, ___value___1)); }
